...
// Vector2 - Vector3
Vector2 operator-(const Vector2 &a, const Vector3 &b) {
    return Vector2Subtract(a, {b.x, b.y});
}

// Vector2 -= Vector3
Vector2 operator-=(Vector2 &a, const Vector3 &b) {
    a = Vector2Subtract(a, {b.x, b.y});
    return a;
}

// Vector2 + Vector3
Vector2 operator+(const Vector2 &a, const Vector3 &b) {
    return Vector2Add(a, {b.x, b.y});
}

// Vector2 += Vector3
Vector2 operator+=(Vector2 &a, const Vector3 &b) {
    a = Vector2Add(a, {b.x, b.y});
    return a;
}
...
Vector3 operator-(const Vector3 &a, const Vector2 &b) {
    return Vector3Subtract(a, {b.x, b.y, 0});
}

// Vector3 -= Vector2
Vector3 operator-=(Vector3 &a, const Vector2 &b) {
    a = Vector3Subtract(a, {b.x, b.y, 0});
    return a;
}

// Vector3 + Vector2
Vector3 operator+(const Vector3 &a, const Vector2 &b) {
    return Vector3Add(a, {b.x, b.y, 0});
}

// Vector3 += Vector2
Vector3 operator+=(Vector3 &a, const Vector2 &b) {
    a = Vector3Add(a, {b.x, b.y, 0});
    return a;
}